...
class DiagnosticMapperTest {
    ...
    @Test
    void codeDescriptionPointsToRuleHelpPage() {
        List<Diagnostic> result = mapper.mapWorkspaceDiagnostics("/workspace", TFLINT_JSON, null, null, null);
        assertThat(result).hasSize(1);
        ...
        assertThat(d.getCodeDescription().getHref())
                .isEqualTo("https://github.com/Qualimetry/sonarqube-terraform-plugin/blob/main/docs/rules/qa-tflint-terraform_naming_convention.md");
    }
