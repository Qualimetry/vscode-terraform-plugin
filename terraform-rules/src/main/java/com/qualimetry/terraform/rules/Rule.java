...
public final class Rule {
    ...
    /** Qualimetry-owned per-rule help page URL. Never null when constructed via RuleRegistry. */
    private final String helpUrl;

    public Rule(String id, String name, String severity, String type, String source,
                String docUrl, String descriptionSummary) {
        this(id, name, severity, type, source, docUrl, descriptionSummary, null, null, null);
    }

    public Rule(String id, String name, String severity, String type, String source,
                String docUrl, String descriptionSummary, String vscodeSeverity) {
        this(id, name, severity, type, source, docUrl, descriptionSummary, vscodeSeverity, null, null);
    }

    public Rule(String id, String name, String severity, String type, String source,
                String docUrl, String descriptionSummary, String vscodeSeverity, List<String> tags) {
        this(id, name, severity, type, source, docUrl, descriptionSummary, vscodeSeverity, tags, null);
    }

    public Rule(String id, String name, String severity, String type, String source,
                String docUrl, String descriptionSummary, String vscodeSeverity, List<String> tags, String helpUrl) {
        this.id = id;
        this.name = name;
    ...
    /** Qualimetry-owned per-rule help page URL; null only when constructed without one. */
