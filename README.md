...
A VS Code extension for static analysis of Terraform (HCL) files. It uses the same rule set as the [Qualimetry Terraform Analyzer for SonarQube](https://github.com/Qualimetry/sonarqube-terraform-plugin). **766 rules** covering misconfigurations, security findings, style and convention violations, and correctness errors — reported in real time as you edit.
